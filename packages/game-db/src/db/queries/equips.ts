...
export function upsertEquipRow(sql: Sqlite, e: EquipRecord): void {
  sql.exec(
    `INSERT INTO equips (
      ...
      inc_speed, inc_jump,
      element_bonus_default, element_bonus_fire, element_bonus_ice,
      element_bonus_lightning, element_bonus_poison,
      cash, equip_type,
    ...
    ON CONFLICT(id) DO UPDATE SET
      ...
      element_bonus_default    = excluded.element_bonus_default,
      element_bonus_fire       = excluded.element_bonus_fire,
      element_bonus_ice        = excluded.element_bonus_ice,
      element_bonus_lightning  = excluded.element_bonus_lightning,
      element_bonus_poison     = excluded.element_bonus_poison,
      cash              = excluded.cash,
    ...
    [
      ...
      e.incSpeed,
      e.incJump,
      e.elementBonusDefault,
      e.elementBonusFire,
      e.elementBonusIce,
      e.elementBonusLightning,
      e.elementBonusPoison,
      e.cash ? 1 : 0,
      e.equipType,
      e.tradeBlock ? 1 : 0,
